...
describe "Admin registered work order" do
  it "sucessfully" do
    ...
    Price.create!(minimum_weight: 0.10, maximum_weight: 0.50, minimum_cubic_meter: 2, maximum_cubic_meter: 1,
    ...
    allow(SecureRandom).to receive(:alphanumeric).and_return("ABCDEFDH1234567")
